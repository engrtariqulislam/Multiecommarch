...
class IndexController extends Controller
{
    public function Index(){
        ...
        return view('frontend.index',compact('skip_category_0','skip_product_0','skip_category_2','skip_product_2','skip_category_4','skip_product_4','skip_category_6','skip_product_6'));
